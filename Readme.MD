...
**Demo:**
[a generated VN, published as a light novel](https://joeedh.github.io/test-visual-novel-1/)
— rendered from `examples/test4` by the GitHub Actions workflow the desktop app installs.
See [`docs/guides/github-pages.md`](docs/guides/github-pages.md) for how to publish your
own.
...
[github.com/joeedh/visualnovel/releases](https://github.com/joeedh/visualnovel/releases)
