 ...
 * (`docs/plans/archive/on-demand-concept-images.md`); a `reference` is the mirror image — bytes the author
 * brought in from outside, generated by nothing and consumed by construction.
 */
