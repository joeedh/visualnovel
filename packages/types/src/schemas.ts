...
/**
 * An author's override of one derived image prompt (`docs/plans/archive/INDEX.md#chunked-prompts`). Stored at
...
/**
 * One prompt condensed from a chunk list by the LLM (`docs/plans/archive/INDEX.md#chunked-prompts` §4).
 *
