 ...
 *
 * The rewires, `setCoverage` and `assignLineIds` are `undoable`: they write the screenplay and
...
export const storyAssignLineIds = define({
  ...
  description:
    'Write the line ids reading already allocated into the screenplay as [[line:]] marks, so ' +
