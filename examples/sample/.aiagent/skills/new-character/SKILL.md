...
when-to-use: The user wants to add a character, or a screenplay references a speaker with no character file.
---
...
4. **Wire them into the screenplay** only if the user asked — a character can exist before
   they appear. If they speak, make sure their lines sit under a `[[scene: …]]` that is
