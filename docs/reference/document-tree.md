...
sheets carry the file they were discovered in ([entity discovery by tag](../plans/archive/INDEX.md#entity-discovery-by-meta-tag)),
...
- **Unapproved assets** is a lens on the two branches around it — everything still standing between
  ...
  [slot graph](../plans/archive/INDEX.md#the-full-slot-graph-and-approving-upstream-first) makes disjoint by
...
- **A row in the Assets branch is a slot, and its children are the takes that slot has had.** A
  ...
  Plans: [`../plans/archive/INDEX.md#superseded-assets-in-the-document-tree`](../plans/archive/INDEX.md#superseded-assets-in-the-document-tree)
