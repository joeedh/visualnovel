...
([`../plans/prompt-caching-and-deferred-tool-loading.md`](../plans/prompt-caching-and-deferred-tool-loading.md)):
...
([`../plans/reporting-a-difficult-agent.md`](../plans/reporting-a-difficult-agent.md)) is explicitly
