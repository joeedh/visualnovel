...
[`plans/improving-the-authoring-agent.md`](../plans/improving-the-authoring-agent.md) (shipped);
...
4. **A batch delete for `edit_scene`.** `insertLines` shipped from
   [`plans/improving-the-authoring-agent.md`](../plans/improving-the-authoring-agent.md) §3.2 and
